...
181 REM *** LINE NUMBERS FROM VERSION TREK7 OF 1/12/75 PRESERVED AS
182 REM *** MUCH AS POSSIBLE WHILE USING MULTIPLE STATEMENTS PER LINE
183 REM ***
190 REM *** MODIFIED TO RUN ON GRANT SEARLE'S 9-CHIP Z80 COMPUTER
191 REM *** AND DERIVATIVES 04-AUG-2018 BY N.KENDRICK
192 REM *** (LINKER3000-AT-GMAIL.COM)
193 REM ***
200 REM *** ADAPTED TO MSBASIC V5.0+ INTEGER ROUNDING ON 18/8/18 BY FEILIPU
201 REM ***
205 RANDOMIZE
209 REM NK: POSITIONING USING ANSI ESCAPE SEQUENCES...
210 PRINT CHR$(26);:PRINT CHR$(27);"=";CHR$(32+1);CHR$(32+1);;
211 PRINT "THE USS ENTERPRISE --- NCC-1701"
212 PRINT CHR$(27);"=";CHR$(32+4);CHR$(32+1);:PRINT
...
226 PRINT TAB(YY);"       ,---' '-------/ /--,"
227 PRINT TAB(YY);"        '----------------'"
228 PRINT CHR$(27);"=";CHR$(32+4);CHR$(32+1);CHR$(24);:PRINT:NEXT YY
229 PRINT CHR$(27);"=";CHR$(32+11);CHR$(32+1);
260 REM CLEAR 600
270 Z$="                         "
...
2020 PRINT:PRINT TAB(10);"** FATAL ERROR **"
...
2300 INPUT"COURSE (1-9)";C1:IF C1>=8.5 THEN C1=C1-8
2310 IF C1>=.5 AND C1<8.5 THEN 2350
...
4550 PRINT K(I,2);CHR$(8);".":IF K(I,3)<=0 THEN PRINT
4551 PRINT "*** KLINGON DESTROYED ***":PRINT:GOTO 4580
...
4760 INPUT"PHOTON TORPEDO COURSE (1-9)";C1:IF C1>=8.5 THEN C1=C1-8
4780 IF C1>=.5 AND C1<8.5 THEN 4850
...
5110 PRINT:PRINT "*** KLINGON DESTROYED ***"
...
6901 IF C$="*RED*" THEN PRINT "*RED*":GOTO 7260  
6902 IF C$="DOCKED" THEN PRINT "DOCKED":GOTO 7260
